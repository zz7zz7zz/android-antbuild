...
//    private final static String[] channelList = new String[]{"A","B","C","D"};//此处初始化市场标识  
    ...
    private final static String projectBasePath = "E:\\workspace\\git_antbuild_project"; //项目的根目录
    private final static String outPutPath = "E:\\workspace\\git_antbuild_project\\outapk"; //apk输出目录
